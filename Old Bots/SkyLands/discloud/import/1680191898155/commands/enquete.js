...
module.exports = {
    ...
    async execute(interaction, client) {
        ...
        try {
            ...
            if (positivo != null) {
                embed.addFields({name: '\u200b', value: `<a:817438197524201505:983125995064295486>  ${positivo}`})
            }
        } catch (error) {
            //pass
        }
        try {
            ...
            if (negativo != null) {
                embed.addFields({name : '\u200b', value:  `<a:817438220098207744:983125997736042536> ${negativo}`})
            }
        } catch (error) {
            //pass
        }
        ...
        } catch(err) {console.log("Arruma os emogis para o Enquete")}
    }
};
